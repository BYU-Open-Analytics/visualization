// From http://bl.ocks.org/nbremer/21746a9668ffdf6d8242, with a few modifications
...
function RadarChart(id, data, options) {
	...
	var blobWrapper = g.selectAll(".radarWrapper")
		.data(data)
		.enter().append("g")
		.attr("class", function(d, i) { return "radarWrapper radar-chart-serie" + i; });
	...
	var blobCircleWrapper = g.selectAll(".radarCircleWrapper")
		.data(data)
		.enter().append("g")
		.attr("class", function(d, i) { return "radarCircleWrapper radar-chart-serie" + i; });
